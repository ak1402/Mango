...
namespace Mango.Services.ShoppingCartAPI.Controllers
{
    ...
    public class CartAPIController : Controller
    {
        ...
        public CartAPIController(ICartRepository cartRepository, ICouponRepository couponRepository, IAmazonSimpleNotificationService sns, IConfiguration config)
        {
        ...
        public async Task<object> Checkout(CheckoutHeaderDto checkoutHeader)
        {
            try
            {
                ...
                publishRequest.Message = JsonSerializer.Serialize(checkoutHeader);
                publishRequest.MessageAttributes = new Dictionary<string, MessageAttributeValue>
                {
                    { AWSSNSActions.Action, new MessageAttributeValue () {
                        DataType = AWSSNSActions.DataTypeString,
                        StringValue = AWSSNSActions.Checkout
                    } }
                };
